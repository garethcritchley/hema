...
/* utilised for the slow text generations. to remove, make sure you genericise the banner in the index.html its the only one still using this code */
    ...
    function e(e) { 
        ...
        list: null, media: {}, events: [], init: function (e) {
            ...
            active: function (e) { var n, a, s, i, r, d, c; if (!(e in t.media)) {
                if (">=" == e.substr(0, 2) ? (a = "gte", n = e.substr(2)) : "<=" == e.substr(0, 2) ? (a = "lte", n = e.substr(2)) : ">" == e.substr(0, 1) ? (a = "gt", n = e.substr(1)) : "<" == e.substr(0, 1) ? (a = "lt", n = e.substr(1)) : "!" == e.substr(0, 1) ? (a = "not", 
